...
const SheetContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof SheetPrimitive.Content> & { side?: 'bottom' | 'top' | 'left' | 'right' }
>(({ side = 'bottom', className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    >
      {children}
      <SheetPrimitive.Close className="absolute right-4 top-4 rounded-xl p-1 opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2">
        <X className="h-4 w-4" />
